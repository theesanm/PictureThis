          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              {registrationSuccess 
                ...
                : 'Join thousands creating amazing AI images'
              }
            </p>
          </div>
          ...
          {registrationSuccess && (
            <div className="mb-6 p-4 bg-green-900/20 border border-green-800 rounded-lg">
              <div className="text-center">
                <h3 className="text-green-400 font-medium mb-2">Welcome, {registrationSuccess.user?.fullName}!</h3>
                <p className="text-green-300 text-sm mb-4">{registrationSuccess.message}</p>
